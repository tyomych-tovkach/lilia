...
export const japanOptions: TalkOption[] = [
  { id: 'еда', playerLine: 'Еда.', npcReact: 'Тогда начнём со вкуса. Пар, соль, сладкое — это уже разговор.' },
  { id: 'поездки', playerLine: 'Поездки.', npcReact: 'Дорога. Значит, вечер может быть про движение, не только про стол.' },
  { id: 'аниме / манга', playerLine: 'Аниме и манга.', npcReact: 'Страницы и кадры. Хорошо — картинка тоже умеет быть свиданием.' },
  { id: 'язык', playerLine: 'Язык.', npcReact: 'Слова. Можно не говорить на нём вслух — достаточно, что он тебе звучит.' },
  { id: 'эстетика', playerLine: 'Эстетика.', npcReact: 'Свет, ткань, тишина. Это я умею стелить на татами.' },
  { id: 'настроение', playerLine: 'Просто настроение.', npcReact: 'И этого хватит. Иногда Япония — только воздух в чашке.' },
]
...
export const japanCustom: CustomTalk = {
  ...
  npcAsk: 'Одно живое слово. Не из списка — ещё лучше.',
  placeholder: 'своё слово про Японию',
  npcReact: 'Не из меню. Значит, настоящее. Положу рядом с чаем.',
...
export const formatOptions: TalkOption[] = [
  { id: 'calm', playerLine: 'Хочу спокойно.', npcReact: 'Тихий вечер. Без табло и без спешки — такое вам двоим к лицу.' },
  { id: 'play', playerLine: 'Хочу поиграть.', npcReact: 'Тогда тело тоже в разговоре. Сейчас уточним, как именно.' },
  { id: 'japan', playerLine: 'Хочу японское.', npcReact: 'Место с характером, не допрос. Какое японское — скажешь следующим жестом.' },
  { id: 'custom', playerLine: 'Есть своё место.', npcReact: 'Напиши, где тебе спокойно. Список на столе — не закон.' },
]

export const flavors: Record<'calm' | 'play' | 'japan', TalkOption[]> = {
  calm: [
    { id: 'кофе с японским акцентом', playerLine: 'Кофе с японским акцентом.', npcReact: 'Кофе. Тихо и тепло — без спектакля вокруг чашки.' },
    { id: 'ужин', playerLine: 'Ужин.', npcReact: 'Стол на двоих. Я как раз такой и накрыла.' },
    { id: 'прогулка', playerLine: 'Прогулка.', npcReact: 'Шаги, без билетов. Город сам будет декорацией.' },
    { id: 'десерт', playerLine: 'Десерт.', npcReact: 'Сладкое — тоже план, не послесловие.' },
  ],
  play: [
    { id: 'теннис', playerLine: 'Теннис.', npcReact: 'Корт. Запомню — пусть будет живой счёт, не лекция.' },
    { id: 'броски', playerLine: 'Броски.', npcReact: 'Кольцо и смех. Это тоже свидание, если вы оба на площадке.' },
    { id: 'волейбол', playerLine: 'Волейбол.', npcReact: 'Сетка. Живо. Можно не играть на победу.' },
    { id: 'посмотреть игру', playerLine: 'Посмотреть игру.', npcReact: 'Трибуна на двоих. Смотреть — тоже быть вместе.' },
  ],
  japan: [
    { id: 'рамен или изакая', playerLine: 'Рамен или изакая.', npcReact: 'Пар и свет. Можно есть руками разговора.' },
    { id: 'караоке', playerLine: 'Караоке.', npcReact: 'Голос можно не беречь. Пусть будет чуть громче, чем страшно.' },
    { id: 'тематическое кафе', playerLine: 'Тематическое кафе.', npcReact: 'Маленькая сцена. Вы двое — весь зал.' },
    { id: 'вечер как мини-фестиваль', playerLine: 'Вечер как мини-фестиваль.', npcReact: 'Фонари в кармане. Не надо ехать в другую страну.' },
  ],
}

export const placeCustom: CustomTalk = {
  playerLine: 'Своё место.',
  npcAsk: 'Как выглядит встреча, которой нет на столе? Напиши место — я не буду править.',
...
export const dateAsk = {
  ...
  when: 'Когда тебе живее приехать? Могу назвать выходные в окне — или напишешь ему сама, когда свободна.',
  otherDay: 'Другой день в этом окне',
  otherDayHint: 'С двенадцатого сентября по третье октября. Точный час оставим чату.',
  slot: 'Днём город ещё шумный, вечером — мягче. Как тебе легче? Час договоритесь сами.',
}

export const slotOptions: TalkOption[] = [
  { id: 'day', playerLine: 'Днём. Город ещё шумный.', npcReact: 'День. Светлый план. Когда будешь готова — почта в том же фойе.' },
  { id: 'evening', playerLine: 'Вечером. Мягче.', npcReact: 'Вечер. Это похоже на вас двоих.' },
]
...
export const copy = {
  ...
  yesAsk: 'Он хочет увидеться с тобой в Краснодаре. Вечер будет ваш. Встретимся?',
  pcNote: 'Эта сцена собрана для ноутбука — удобнее с клавиатурой и мышью.',
}

export const greetings: Record<LocationId, string[]> = {
  hub: [
    'Лилия. Я Таня. Фойе в цвету: сакура, свитки, тихий розовый свет.',
  ...
  letter: [
    'Я Соня — со стороны невесты. Мы тогда танцевали в одной зале.',
    'Он в отпуске с семьёй, поэтому прислал сад и письмо. Прочти своими глазами.',
  ],
  japan: [
    'Садись. Чай уже тёплый. Япония тут не экзамен и не меню — можно одно слово, можно два, можно пройти мимо.',
    'Что откликается, если закрыть глаза? Еда, дорога, картинка, язык, свет — или просто воздух. Клади живое.',
  ],
  ...
  yesno: ['Сцена почти готова. Вопрос простой, и «нет» здесь тоже ответ.'],
  date: ['Я Катя. Стол на двоих — без анкеты. Соберём вечер, который вам по силам, а не правильный ответ.'],
  send: [
    'Я Гена, почта. Письмо одно, без черновиков на столе и без подписи с твоей стороны.',
    'Глянь, что сложилось. Если похоже на тебя — клади в ящик. Он напишет сам.',
  ],
...
export const farewells: Record<LocationId, string> = {
  ...
  letter: 'Письмо твоё. Мостик — левая арка, если смотришь на сцену. Чайная, корт и крыша — справа, если захочешь.',
  japan: 'Запомню. Корт — дальше по правой стене, если захочешь; если нет — тоже чай.',
  sport: 'Ок. Крыша — ещё дальше по правой стене, если хочется чуть больше о себе.',
  secret: 'Хорошо. Мостик — левая арка дальней стены.',
  yesno: 'Хорошо. Стол бронирования — справа от мостика.',
  date: 'Договорились. Когда будешь готова отправить — почта крайняя справа, если смотришь на сцену.',
