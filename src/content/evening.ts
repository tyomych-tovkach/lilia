...
export const slotOptions: TalkOption[] = [
  { id: 'day', playerLine: 'День.', npcReact: 'День. Почта — слева по фойе, синяя арка.' },
  { id: 'evening', playerLine: 'Вечер.', npcReact: 'Вечер. Почта — слева по фойе, синяя арка.' },
]
...
export const copy = {
  ...
  noDodge: '«Нет» ускакало. Неловкий реквизит — без обид.',
...
export const greetings: Record<LocationId, string[]> = {
  ...
  sport: ['Короткая разминка. Какой спорт твой? Можно один.', 'А как — смотришь, играешь, учишь? Можно не выбирать.'],
...
export const farewells: Record<LocationId, string> = {
  ...
  japan: 'Запомню. Корт рядом, если ноги просят мяч.',
  sport: 'Ок. Крыша выше по коридору — если хочется ещё чуть-чуть о себе.',
  secret: 'Хорошо. Мостик — в центре северной стены.',
  yesno: 'Хорошо. Стол бронирования зажёгся слева от мостика.',
  date: 'Договорились. Почта — крайняя слева, синяя арка.',
