  ...
  return (
    <>
      ...
      <mesh position={[-2.35, 1.8, -half + 1.15]}>
        <cylinderGeometry args={[0.16, 0.2, 3.5, 32]} />
      ...
      <HungChochin position={[-2.1, 2.55, -1.1]} />
      <HungChochin position={[2.1, 2.55, -1.1]} />
      ...
      <Bench position={[2.7, 0, 4.55]} rotationY={-0.15} />
      <GetaPair position={[-1.1, 0, 7.35]} />
      <GetaPair position={[1.1, 0, 7.35]} />
      <Zabuton position={[0, 0.04, 1.55]} color="#c45c7a" />
      <Petals />
...
export function GardenSet({ half, children }: { half: number; children?: ReactNode }) {
  return (
    <>
      <RoomLights sky="#8eb8d0" fog={['#c5d4c8', 18, 36]} ambient={0.48} dirIntensity={1.15} dirColor="#ffe2b0" />
      <Floor half={half} color="#3a5a32" kind="grass" />
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0.42, 0.02, 0.85]}>
        <planeGeometry args={[1.45, 5.2]} />
        <meshStandardMaterial color="#c4b8a0" roughness={0.92} />
      </mesh>
      <mesh position={[-1.55, 0.07, -1.45]}>
        <cylinderGeometry args={[2.38, 2.38, 0.14, 48]} />
        <meshStandardMaterial color="#7a7468" roughness={0.88} />
      </mesh>
      <mesh position={[-1.55, 0.12, -1.45]}>
        <cylinderGeometry args={[2.18, 2.18, 0.04, 48]} />
        <meshStandardMaterial color="#5a9aaa" transparent opacity={0.55} roughness={0.12} metalness={0.22} />
      </mesh>
      ...
      <Koi position={[-1.2, 0.16, -0.8]} />
      <Koi position={[-2.1, 0.15, -1.8]} color="#c45c4a" />
      <Koi position={[-0.7, 0.16, -2.2]} color="#e8a060" />
...
export function TeaSet({ half, children }: { half: number; children?: ReactNode }) {
  return (
    <>
      <RoomLights sky="#140c0a" fog={['#1c100c', 4, 12]} ambient={0.16} dirIntensity={0.08} dirColor="#ffb070" />
      <Floor half={half} color="#8a6a3a" kind="tatami" />
      <WallRing half={half} color="#f0e0d0" height={2.85} kind="plaster" />
      ...
      {[-1.82, 0, 1.82].map((x, i) =>
        [-0.2, -1.12, -2.04].map((z) => (
          <mesh key={`${x}:${z}`} position={[x, 0.04, z]}>
            <boxGeometry args={[1.82, 0.08, 0.91]} />
            <Mat color={i % 2 ? '#c4a86a' : '#b89858'} kind="tatami" />
          </mesh>
        )),
      )}
      <Noren position={[0, 0, 1.25]} label="茶" />
      ...
      <pointLight position={[0, 1.6, -6.4]} color="#f0d8b0" intensity={0.5} distance={7} />
      <Lantern position={[-1.7, 1.4, 0.15]} />
      <Lantern position={[1.7, 1.4, 0.15]} />
      <Lantern position={[-0.4, 1.35, -2.85]} />
      <GetaPair position={[0, 0, 3.55]} />
      <Bench position={[-2.6, 0, 3.2]} />
      <RoomBounds half={half} />
      {children}
    </>
  )
...
export function CourtSet({ half, children }: { half: number; children?: ReactNode }) {
  return (
    <>
      <RoomLights sky="#1a2430" fog={['#8aa8c0', 18, 36]} ambient={0.48} dirIntensity={0.55} dirColor="#e8f0ff" />
      ...
      <WallRing half={half} color="#e8dcc8" height={5.2} kind="plaster" />
      <mesh position={[0, 5.35, 0]}>
        <boxGeometry args={[14.8, 0.12, 14.8]} />
        <meshStandardMaterial color="#3a4038" />
      </mesh>
      {[-5.2, -2.6, 0, 2.6, 5.2].map((z) => (
        <mesh key={z} position={[0, 5.18, z]}>
      ...
      {[
        ...
        <pointLight key={`${x}:${z}`} position={[x, y, z]} color="#fff4d0" intensity={0.75} distance={9} />
      ))}
      {[
      ...
      <RuSign text="0 : 0" position={[0, 3.85, -half + 0.25]} size={0.22} color="#ffd27a" />
      ...
      {[-4.4, -1.5, 1.4, 4.3].map((z) => (
        <mesh key={`wL${z}`} position={[-half + 0.22, 3.35, z]}>
          ...
          <meshStandardMaterial color="#7ecbff" transparent opacity={0.22} roughness={0.08} />
        </mesh>
      ))}
...
export function RoofSet({ half, children }: { half: number; children?: ReactNode }) {
  return (
    <>
      <RoomLights sky="#0c1020" fog={['#12182c', 10, 28]} ambient={0.14} dirIntensity={0.42} dirColor="#c8d4ff" />
      ...
      {[-2.4, -0.8, 0.8, 2.4].map((x) => (
        <mesh key={x} position={[x, 2.05 - Math.abs(x) * 0.04, -1.1]}>
      ...
      <Lantern position={[1.6, 1.5, -1.8]} />
      <pointLight position={[0, 3.1, -0.4]} color="#a090ff" intensity={0.32} distance={11} />
...
export function BridgeSet({ half, children }: { half: number; children?: ReactNode }) {
  ...
  useFrame((st, dt) => {
    ...
    if (water.current) {
      water.current.position.y = -0.06 - 0.16 * t
  ...
  return (
    <>
      <RoomLights sky={sky} fog={[stage >= 2 ? '#1a0810' : '#1c2438', stage >= 2 ? 6 : 9, stage >= 2 ? 16 : 22]} ambient={stage >= 2 ? 0.08 : 0.14} dirIntensity={stage >= 2 ? 0.18 : 0.38} dirColor={stage >= 2 ? '#c070ff' : '#d0d8ff'} />
      <Floor half={half} color={stage >= 2 ? '#0e2030' : '#1a3850'} kind="stone" />
      <mesh ref={water} rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.06, 0]}>
        <planeGeometry args={[half * 2, half * 2]} />
        <meshStandardMaterial color="#16344c" roughness={0.18} metalness={0.28} transparent opacity={0.72} />
      </mesh>
      <mesh ref={ghost} rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.052, 0]} visible={false}>
        <planeGeometry args={[half * 2, half * 2]} />
      ...
      <mesh position={[0, 0.04, 3.35]}>
        <boxGeometry args={[2.6, 0.08, 3.3]} />
      ...
      <Koi position={[1.8, 0.08, 0.4]} />
      <Koi position={[-2.1, 0.07, -0.8]} color="#c45c4a" />
      <Koi position={[0.6, 0.09, -2.6]} />
...
export function TableSet({ half, children }: { half: number; children?: ReactNode }) {
  return (
    <>
      <RoomLights sky="#1c1410" fog={['#241818', 8, 16]} ambient={0.18} dirIntensity={0.08} dirColor="#ffc070" />
      ...
      <mesh position={[2.35, 1.72, -half + 0.22]}>
        ...
        <meshStandardMaterial color="#9bb8d0" transparent opacity={0.22} roughness={0.06} />
      </mesh>
      ...
      <pointLight position={[-0.2, 2.55, -1.55]} color="#ffd8a8" intensity={0.65} distance={7} />
      <RoomBounds half={half} />
      {children}
    </>
  )
...
export function PostSet({ half, children }: { half: number; children?: ReactNode }) {
  return (
    <>
      <RoomLights sky="#181820" fog={['#1c1824', 8, 18]} ambient={0.26} dirIntensity={0.28} dirColor="#8a9cc0" />
      ...
      <pointLight position={[0.55, 1.85, -2.05]} color="#ffd27a" intensity={0.5} distance={4} />
      <RoomBounds half={half} />
      {children}
    </>
  )
...
export function CampusSet({ half, children }: { half: number; children?: ReactNode }) {
  return (
    <>
      <RoomLights sky="#c5d6e6" fog={['#c5d6e6', 18, 36]} ambient={0.55} dirIntensity={1.35} dirColor="#fff1d2" />
...
export function StaffSet({ half, children }: { half: number; children?: ReactNode }) {
  return (
    <>
      <RoomLights sky="#152018" fog={['#1a2420', 10, 20]} ambient={0.32} dirIntensity={0.15} dirColor="#c8d8c0" />
      ...
      {[-1.6, 1.6].map((x) => (
        <group key={x}>
          <mesh position={[x, 2.85, -1.2]}>
            <boxGeometry args={[1.2, 0.04, 0.08]} />
            <meshStandardMaterial color="#e8f0d8" emissive="#e8f4d0" emissiveIntensity={0.9} />
          </mesh>
          <pointLight position={[x, 2.85, -1.2]} color="#e8f4d0" intensity={0.5} distance={7} />
        </group>
      ))}
      <VkusnoLogo position={[-0.35, 1.85, -3.55]} />
      <RuSign text="ПЕРСОНАЛ" position={[0.9, 2.62, -3.48]} size={0.15} color="#f4ead8" />
